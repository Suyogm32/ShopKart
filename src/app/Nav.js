  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 gap-2 fixed w-full h-full bg-bgGray dark:bg-gray-800 dark:text-gray-300 md:static md:w-auto transition-all"
      }
    >
      ...
      <nav className="mb-4">
        ...
        <Link href="/orders" className={pathname.startsWith("/orders") ? activelink : inactivelink}>
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.startsWith("/orders") ? activeIcon : inactiveIcon}
            style={{ width: "2rem", height: "2rem" }}
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.startsWith("/catagories") ? activeIcon : inactiveIcon}
            style={{ width: "2rem", height: "2rem" }}
          >
            <path
              strokeLinecap="round"
        ...
        <Link
          ...
          className={pathname.startsWith("/delivery-agents") ? activelink : inactivelink}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.startsWith("/delivery-agents") ? activeIcon : inactiveIcon}
            style={{ width: "2rem", height: "2rem" }}
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={pathname.startsWith("/settings") ? activeIcon : inactiveIcon}
            style={{ width: "2rem", height: "2rem" }}
          >
            <path
              strokeLinecap="round"
